...
export const projects = [
  {
    ...
    description: 'A complete transformation of a 1950s beach cottage into a stunning contemporary coastal home with ocean views from every level.',
    image: projectBondiImg,
    gallery: [projectBondiImg, kitchenRenoImg, bathroomRenoImg],
    year: 2024,
    duration: '8 months',
  },
  {
    ...
    description: 'Heritage-sensitive extension to a Federation home, adding modern living spaces while preserving original character features.',
    image: projectMosmanImg,
    gallery: [projectMosmanImg, homeRenoImg, kitchenRenoImg],
    year: 2024,
    duration: '12 months',
  },
  {
    ...
    location: 'Toorak, VIC',
    category: 'New Build',
    description: 'Award-winning contemporary home featuring innovative indoor-outdoor living spaces, timber cladding, and sustainable design principles.',
    image: projectMelbourneImg,
    gallery: [projectMelbourneImg, bathroomRenoImg, deckingImg],
    year: 2023,
    duration: '14 months',
  },
];
